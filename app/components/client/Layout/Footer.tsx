                ...
                <div className="flex items-center gap-[20px]">
                  {socialMedia.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <span className="absolute inset-x-0 bottom-0 h-0 bg-primary group-hover:h-full transition-all duration-300 ease-in-out" />
                        ...
                        <Image
                          ...
                          width={24}
                          height={24}
                          className="relative z-10 pointer-events-none object-contain w-[24px] h-[24px]"
                        />
                      </Link>
                    </motion.div>
                  ))}
            ...
            <Link href="/" className="">
              ...
              >
                <Image
                  ...
                  width={253}
                  height={67}
                  className="pointer-events-none w-[210px] md:w-[250px] max-h-[75px] lg:w-[253px] lg:h-[67px]"
                />
              </motion.div>
            </Link>
            ...
            <div className="col-span-1 xl:col-span-2">
              ...
              <div className="flex items-center gap-[20px] ml-1">
                {(
                  Object.keys(
                    contactLocations,
                  ) as (keyof typeof contactLocations)[]
                ).map((key) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex items-center gap-[12px] transition-colors duration-300 cursor-pointer font-nexa font-bold text-20 mb-[20px] ${
                        isActive
                          ? "text-white"
                          : "text-paragraph hover:text-white"
                      }`}
                    >
                      <span
                ...
                <div className="relative xl:w-[190px] xl:h-[190px] w-[140px] h-[140px] flex items-center justify-center">
                  ...
                  <div className="relative z-10 p-[13px]">
                    <Image
                      ...
                      width={164}
                      height={164}
                      className="pointer-events-none w-[164px] h-[164px]"
                    />
                  </div>
                </div>
              </div>
