    ...
    >
      <div className="container flex items-center justify-between max-h-[124px] py-7 3xl:py-[30px]">
        ...
        <Link
          ref={logoRef}
          href="/"
          className="relative flex items-center w-[170px] 2xl:w-[234px] h-[62px] shrink-0"
        >
          <Image
        ...
        <div className="flex items-center">
          <div
            ref={navItemsRef}
            className="flex items-center lg:gap-[25px] xl:gap-[40px] 3xl:gap-[69px]"
          >
            {NAV_ITEMS.map((item) => (
              <div
                key={item.label}
              ...
              >
                <div
                  className={`flex items-center gap-2 cursor-pointer transition-colors duration-300 ${isActive ? "text-secondary" : "text-paragraph-2"}`}
                >
                  {item.href ? (
                    <Link
                      href={item.href}
