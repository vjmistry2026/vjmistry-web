...
export default function Navbar() {
    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full z-50 transition-colors duration-400 ${isActive ? "bg-white" : "bg-transparent"}`}
        ...
        >
            <div className="container flex items-center justify-between max-h-[124px] py-[30px]">
                {/* Logo */}
                <Link href="/" className="relative flex items-center w-[180px] 2xl:w-[234px] h-[62px]">
                    <Image
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-center gap-8 md:gap-8 3xl:gap-[69px]">
                        {NAV_ITEMS.map((item) => (
                                ...
                                >
                                    ...
                                    {item.children && (
                                        <Image
                                            ...
                                            width={16}
                                            height={7}
                                            className={`transition-transform duration-300 ${hoveredItem === item.label ? "rotate-180" : ""} ${hovered ? "invert" : ""}`}
                                        />
                                    )}
                                </div>
