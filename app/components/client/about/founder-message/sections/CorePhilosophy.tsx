    ...
    <section className="bg-light py-130">
      <div className="container">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.2 }}
          className="grid grid-cols-1 gap-px border border-border  xl:grid-cols-3"
        >
          {items.map((item,index) => {
            ...
            return (
              <motion.article
                ...
                className="group relative cursor-pointer overflow-hidden bg-white p-6 outline-none min-h-[250px] sm:min-h-[280px] xl:max-h-[285px] p-30" >
                ...
                <div
                  className={`absolute inset-0 bg-[linear-gradient(180deg,#ED1C24_0%,#A71E22_100%)] transition-transform duration-500 ease-out ${
                    isActive ? "translate-y-0" : "translate-y-full"
                  }`}
                />

                <Image src="/assets/icons/vj-crd-shape.svg" alt="" width={300} height={300}
                  className={`pointer-events-none absolute right-0 top-0 h-[190px] w-auto object-contain object-top-right transition-opacity duration-500 
