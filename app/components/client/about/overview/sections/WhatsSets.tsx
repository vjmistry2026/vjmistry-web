...
const WhatSetsUsApart = () => {
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="relative bg-secondary py-100 md:py-130 overflow-hidden"
      >
        ...
        <div className="container relative z-10">
          <h2 className="section-heading text-paragraph-2 mb-[40px] md:mb-[50px] lg:mb-[60px]">
            {heading}
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-[24px] lg:p-[30px] h-full cursor-pointer relative flex flex-col justify-between z-20">
                    <div
                      className={`w-[60px] h-[60px] flex items-center justify-center transition-colors duration-300 shrink-0 mb-[33px] ${isActive ? "bg-secondary" : "bg-paragraph-2"}`}
                    >
                      <Image
                        src={feature.icon}
                        alt={feature.title}
                    ...
                    <div className="shrink-0">
                      ...
                      <div
                        className="feature-desc grid transition-all duration-300"
                        style={{ gridTemplateRows: isActive ? "1fr" : "0fr" }}
                      >
                        <div className="overflow-hidden">
                          <p
                            className={`section-description text-paragraph-2/70 transition-opacity duration-300 ${isActive ? "opacity-100 mt-5" : "opacity-0 mt-0"}`}
                          >
                            {feature.description}
                          </p>
                        </div>
