...
const Main = ({ data }: { data: CertificateType['firstSection'] }) => {
  return (
    <section className="py-40 xl:py-150 relative overflow-hidden">
      <div className="absolute bottom-0 2xl:bottom-[-8%] right-0 opacity-80 z-0">
      ...
      <div className="container">
        <AnimatedHeading text={data.title} className="mb-30 max-w-xl" />
