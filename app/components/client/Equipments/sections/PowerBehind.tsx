...
const PowerBehind = ({ data }: { data: EquipmentType['secondSection'] }) => {
                        ...
                        >
                            ...
                            >
                                {data.items.map((item, i) => (
                                    <div
                                        key={i}
                                        className={`py-2 lg:py-5 md:border-r border-black/20 ${i === statsData.length - 1 ? "md:border-r-0" : ""
                                            } ${i !== 0 ? "" : ""}`}
                                    >
                                        <div className={`${i === 0 ? " lg:w-fit xl:w-auto  mx-auto" : ""} ${i === 3 ? " xl:ms-auto xl:me-0 lg:m-auto lg:w-fit" : ""} ${i !== 0 && i !== 3 ? "lg:w-fit mx-auto" : ""}`}>
                                            <h3 className={`${i === 2 ? "xl:min-w-[230px]" : " lg:min-w-[160px]"} mb-[10px] text-primary font-bold text-[45px] md:text-[60px] lg:text-[70px] xl:text-[80px] 3xl:text-[85px] leading-[1.18]`}  >  {item.number}
                                            </h3>
